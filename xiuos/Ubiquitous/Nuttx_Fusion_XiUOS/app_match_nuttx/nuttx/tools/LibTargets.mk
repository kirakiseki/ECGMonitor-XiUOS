...
export libcdir = libc-musl
else
export libcdir = libc
endif

libs$(DELIM)$(libcdir)$(DELIM)libkc$(LIBEXT): pass2dep
	$(Q) $(MAKE) -C libs$(DELIM)$(libcdir) libkc$(LIBEXT) EXTRAFLAGS="$(KDEFINE) $(EXTRAFLAGS)"

staging$(DELIM)libkc$(LIBEXT): libs$(DELIM)$(libcdir)$(DELIM)libkc$(LIBEXT)
	$(Q) $(call INSTALL_LIB,$<,$@)
...
ifeq ($(CONFIG_BUILD_FLAT),y)
libs$(DELIM)$(libcdir)$(DELIM)$(libcdir)$(LIBEXT): pass2dep
else
libs$(DELIM)$(libcdir)$(DELIM)$(libcdir)$(LIBEXT): pass1dep
endif
	$(Q) $(MAKE) -C libs$(DELIM)$(libcdir) $(libcdir)$(LIBEXT) EXTRAFLAGS="$(EXTRAFLAGS)"

staging$(DELIM)$(libcdir)$(LIBEXT): libs$(DELIM)$(libcdir)$(DELIM)$(libcdir)$(LIBEXT)
	$(Q) $(call INSTALL_LIB,$<,$@)
